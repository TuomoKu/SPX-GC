...
class Graphic extends HTMLElement {
  ...
  async load(params) {
    ...
    iframe.width = "100%";
    iframe.height = "100%";
    iframe.src = import.meta.resolve("./resources/Name_right/NAME_RIGHT.html"); 
    iframe.onload = () => {
      ...
      document.getElementById("f99").innerText = params.data.f99.replace("resources/Name_right/", "");
    }
  ...
  async customAction(params) {
    // No actions are implemented in this example
  }
}
