...
class Graphic extends HTMLElement {
  ...
  async load(params) {
    ...
    iframe.width = "100%";
    iframe.height = "100%";
    iframe.src = import.meta.resolve("./resources/Ticker_excel/TICKER_EXCEL.html"); 
    iframe.onload = () => {
      const document = iframe.contentWindow.document;
      document.getElementById("f0").innerText = params.data.f0;
      document.getElementById("f1").innerText = params.data.f1.replace("resources/Ticker_excel/", "");
      document.getElementById("f2").innerText = params.data.f2;
      document.getElementById("f3").innerText = params.data.f3;
      document.getElementById("f99").innerText = params.data.f99.replace("resources/Ticker_excel/", "");
    }
